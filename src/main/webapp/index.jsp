        ...
        <div class="carousel">
            <!-- <div class="slider">
                <div class="slide-content">
                    ...
                    <p class="movie-des">test Lorem ipsum title, sit amet consectetur adipisicing elit. Quam distinctio molestiae quis praesentium cum obcaecati eveniet voluptates exercitationem eum accusantium.</p>
                </div>
        ...
        <div class="card-container">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h6 class="des">Test Message Lorem ipsum dolor sit consectetur elit...</h6>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h6 class="des">test Sailaja ipsum dolor sit consectetur elit.</h6>
                    <button class="watchlist-btn">add to watchlist</button>
                </div>
            </div>
            <div class="card">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h6 class="des">Test message Lorem shubham color sit consectetur elit.</h6>
                    <button class="watchlist-btn">add to watchlist</button>
                </div>
            </div>
            <div class="card">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h6 class="des">Test Lorem ipsum Tan sit consectetur elit.</h6>
                    <button class="watchlist-btn">add to watchlist</button>
                </div>
            </div>
            <div class="card">
